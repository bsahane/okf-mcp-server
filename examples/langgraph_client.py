"""LangGraph MCP Client Example - OKF MCP Server Integration.
...
async def get_agent_redhat():
    ...
    - Tools from the OKF MCP server (e.g., search_knowledge)
...
async def demonstrate_tool_calls():
    ...
    The example uses the knowledge tools to answer questions with citations
