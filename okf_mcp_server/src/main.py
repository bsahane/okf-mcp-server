"""Main entry point for the OKF MCP Server."""
...
from okf_mcp_server.src.settings import validate_config as validate_config_func
from okf_mcp_server.utils.pylogger import get_python_logger, get_uvicorn_log_config
...
def main() -> None:
    ...
    Initializes logging, loads configuration, and starts the OKF MCP server.
    ...
    try:
        ...
        logger.info("OKF MCP server shutting down")
