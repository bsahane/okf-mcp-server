"""Settings for the OKF MCP Server."""
...
class Settings(BaseSettings):
    """Configuration settings for the OKF MCP Server.
    ...
    OKF_DATA_DIR: str = Field(
        default="./data",
        json_schema_extra={
            "env": "OKF_DATA_DIR",
            "description": (
                "Directory holding published knowledge snapshots; `current` points at "
                "the snapshot (bundle, extraction metadata and index) being served"
            ),
            "example": "/var/lib/okf",
        },
    )
