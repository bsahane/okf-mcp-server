...
from okf_mcp_server.src.settings import Settings, parse_sso_scopes


class TestOAuth2Handler:
    """Test class for OAuth2Handler."""

    @patch("okf_mcp_server.src.oauth.handler.settings")
    def test_create_oauth_session_without_state(self, mock_settings):
        ...
        with patch("okf_mcp_server.src.oauth.handler.OAuth2Session") as mock_oauth:
            mock_session = Mock()
    ...
    @patch("okf_mcp_server.src.oauth.handler.OAuth2Handler.create_oauth_session")
    ...
    @patch("okf_mcp_server.src.oauth.handler.settings")
    @patch("okf_mcp_server.src.oauth.introspection.httpx.post")
    ...
    @patch("okf_mcp_server.src.oauth.handler.OAuth2Handler.introspect_token")
    ...
    @patch("okf_mcp_server.src.oauth.handler.OAuth2Handler.verify_access_token")
...
class TestOAuth2HandlerIntegration:
    ...
    @patch("okf_mcp_server.src.oauth.handler.settings")
    @patch("okf_mcp_server.src.oauth.handler.OAuth2Session")
    @patch("okf_mcp_server.src.oauth.introspection.httpx.post")
