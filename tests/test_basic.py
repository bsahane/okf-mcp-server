"""Basic tests for the OKF MCP Server."""
...
import okf_mcp_server.src.settings as settings_mod
...
class TestSettings:
    ...
    def test_default_settings(self):
        ...
        # Arrange
        with patch("okf_mcp_server.src.settings.Settings") as mock_settings_class:
            mock_settings = Mock()
...
class TestServer:
    ...
    def patch_snowflake_account(self, monkeypatch):
        ...
        import okf_mcp_server.src.mcp as server_mod

        importlib.reload(server_mod)
        self.OKFMCPServer = server_mod.OKFMCPServer
    ...
    def test_health_endpoint(self):
        ...
        # Arrange
        with patch("okf_mcp_server.src.api.app") as mock_app:
            mock_app.routes = [Mock(path="/health")]

            # Act
            from okf_mcp_server.src.api import app
...
class TestMain:
    ...
    def test_main_module_import(self):
        ...
        import okf_mcp_server.src.main as main
...
class TestIntegration:
    ...
    def test_module_imports(self):
        ...
        modules_to_test = [
            "okf_mcp_server.src.mcp",
            "okf_mcp_server.src.settings",
            "okf_mcp_server.src.main",
            "okf_mcp_server.src.tools.browse_knowledge_tool",
            "okf_mcp_server.src.tools.search_knowledge_tool",
            "okf_mcp_server.src.tools.get_knowledge_tool",
            "okf_mcp_server.src.knowledge.index",
            "okf_mcp_server.src.ingest.pipeline",
            "okf_mcp_server.utils.pylogger",
        ]
    ...
    def test_package_structure(self):
        ...
        assert okf_mcp_server is not None

        # Test that src package exists
        import okf_mcp_server.src

        assert okf_mcp_server.src is not None

        # Test that utils package exists
        import okf_mcp_server.utils

        assert okf_mcp_server.utils is not None

    def test_version_consistency(self):
        """Test that version information is consistent."""
        try:
            from okf_mcp_server import __version__
